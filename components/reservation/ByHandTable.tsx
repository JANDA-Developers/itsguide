...
export const ByhandTable: React.FC<IReservationTableProp> = ({
    bookingListHook,
    handlers,
    idSelectHook,
}) => {
        ...
        <div className="master__table">
            ...
            {items.map((item, i) => (
                <div key={item._id} className="tbody">
                    ...
                    <div className="t02">
                        <div className="align">
                            <strong className="r-number">
                                <i className="m_title">예약번호:</i>
                                {item.code}
                            </strong>
                            <span className="pay-day">
                                <i className="m_title">결제일:</i>
                                {yyyymmdd(item.payment?.createdAt)}
                            </span>
                            <span className="goods-ct">
                                <i className="m_title">유형:</i>
                                {itemTypeToKr(item.product.type)}
                            </span>
                        </div>
                    </div>
                    <div className="t03">
                        <div className="info goods__info_title">
                            ...
                            <div className="txt">
                                ...
                                <span className="men">
                                    인원: 총 {item.totalCount}명 (성인:
                                    {item.adultCount}/소아:{item.kidCount}/유아:
                                    {item.babyCount})
                                </span>
                            </div>
                        </div>
                    ...
                    <div className="t04">
                        <div className="align">
                            <strong className="name">
                                <i className="m_title">예약자명:</i>
                                {item.name}
                            </strong>
                            <span className="patner-name">
                                <i className="m_title">가이드명:</i>(
                    ...
                    <div className="t06">
                        <div className="align">
                            <strong>
                                <span className="cansel stand">
                                    {bookingStatus(item.status)}
                                </span>
                            </strong>
                            <span className="refund-btn stand">
                                <i className="m_title">환불상태:</i>
                        ...
                        <div className="align">
                            ...
                            >
                                ...
                                <i
                                    ...
                                    data-tip="카드결제일 경우 환불 처리, 무통장일 경우 표기만 변경됨."
                                />
                            </button>
                        </div>
                    </div>
            ...
            <div className="fin ifMobile">
                ...
                <div className="float_right">
                    <button
                        onClick={handleSelectCancelConfirm}
                        type="submit"
                        className="btn medium"
                    >
                        선택 환불완료
