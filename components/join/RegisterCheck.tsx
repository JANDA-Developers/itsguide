...
const RegisterCheck: React.FC<IProps> = ({ registerInfo }) => {
    ...
    const { nodes: sharedValidate } = new Validater([
        ...
        {
            value: (registerInfo.guideLicenses?.length || 0) >= 1,
    ...
    const { validate: BpartnerValidate } = new Validater([...sharedValidate]);
                ...
                <div className="agreeChk_list">
                    <ul>
                        ...
                        <li>
                            ...
                            <div className="in_box2">
                                <a onClick={openModal("#PrivacyPolicy")}>
                                    전문보기 &gt;
                                </a>
                            </div>
                        </li>
                        ...
                        <li>
                            ...
                            <div className="in_box2">
                                <a onClick={openModal("#TravelerPolicy")}>
                                    전문보기 &gt;
                                </a>
                            </div>
                        </li>
                        <li>
                            ...
                            <div className="in_box2">
                                <a onClick={openModal("#PartnerPolicy")}>
                                    전문보기 &gt;
                                </a>
                            </div>
                        </li>
                        <li>
                            ...
                            <div className="in_box2">
                                <a onClick={openModal("#MarketingPolicy")}>
                                    전문보기 &gt;
                                </a>
                            </div>
                        </li>
                        <li>
                            ...
                            <div className="in_box2">
                                <a onClick={openModal("#ThirdPolicy")}>
                                    전문보기 &gt;
                                </a>
                            </div>
                        </li>
