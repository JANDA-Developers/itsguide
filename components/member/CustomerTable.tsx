...
export const CustomerTable: React.FC<IMemberTableProp> = ({
    userHook,
    idSelectHook,
    handleUser,
}) => {
    ...
    return (
        <div className="master__table con_box_body">
                ...
                <div key={user._id} className="list_line">
                    ...
                    <div className="td04">
                        ...
                        <Link href={`tel:${user.phoneNumber}`}>
                            <a>{autoHypenPhone(user.phoneNumber)}</a>
                        </Link>
                    </div>
                    <div className="td05">
                    ...
                    <div className="td06">
                        <i className="m_title">국적:</i>
                        {foreginKR(user.is_froreginer)}
                    </div>
                    <div className="td07">
                        <i className="m_title">가입일:</i>
                        {yyyymmdd(user.createdAt)}
                    </div>
                    <div className="td08">
                        <i className="m_title">주소:</i>
                        {user.address.slice(0, 10) + "..."}
                    </div>
                    <div className="td09">
                        <i
                            className="btn small"
                            onClick={handleViewDetailUser(user._id)}
                        >
                            상세보기
                        </i>
                        <i
                            className="btn small"
                            onClick={handleViewUserBoard(user)}
                        >
                            작성한 게시글
                        </i>
                    </div>
