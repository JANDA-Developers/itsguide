...
export const HandBookingModal: React.FC<IProp> = ({ defaultProductId }) => {
    ...
    if (item) {
        totalPrice =
            input.adultCount * item?.adult_price +
