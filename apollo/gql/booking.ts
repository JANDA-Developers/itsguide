...
export const BOOKING_COUNT = gql`
    query bookingCount($filter: _BookingFilter) {
        BookingList(
            pageInput: { page: 1, cntPerPage: 99999999 }
            filter: $filter
        ) {
            ok
            error {
...
export const BOOKING_CANCEL_REQ = gql`
    mutation bookingCancelReq($bookingId: String!, $reason: String!) {
        BookingCancelReq(bookingId: $bookingId, reason: $reason) {
            ok
            error {
                location
                severity
...
export const BOOKING_CANCEL_REJECT = gql`
    mutation bookingCancelReject($bookingId: String!, $reason: String!) {
        BookingCancelReject(bookingId: $bookingId, reason: $reason) {
            ok
            error {
                location
                severity
...
export const BOOKINGS_CREATE = gql`
    mutation bookingsCreate(
        ...
        BookingsCreate(payMethod: $payMethod, params: $params) {
            ok
            error {
                location
                severity
...
export const BOOKING_DELETE = gql`
    mutation bookingDelete($id: String!) {
        BookingDelete(id: $id) {
            ok
            error {
                location
...
export const BOOKING_UPDAET = gql`
    mutation bookingUpdate($params: BookingUpdateInput!, $id: String!) {
        BookingUpdate(params: $params, _id: $id) {
            ok
            error {
                location
                severity
...
export const BOOKING_COMPLETE_BY_HAND = gql`
    mutation bookingCompleteByHand($params: BookingCompleteByHandInput!) {
        BookingCompleteByHand(params: $params) {
            ok
            error {
                location
                severity
...
export const BOOKING_CANCEL_BYHAND = gql`
    mutation bookingCancelByHand($params: BookingCancelByHandInput!) {
        BookingCancelByHand(params: $params) {
            ok
            error {
                location
                severity
...
export const BOOKING_FIND_BY_CODE = gql`
    query bookingFindByCode($code: String!) {
        BookingFindByCode(code: $code) {
            ok
            error {
                location
                severity
