import {
    BOOKINGS_CREATE,
    BOOKING_CANCEL_BYHAND,
    BOOKING_CANCEL_REJECT,
    BOOKING_CANCEL_REQ,
    BOOKING_COMPLETE_BY_HAND,
    BOOKING_CREATE_BY_HAND,
    BOOKING_DELETE,
    BOOKING_FIND_BY_CODE,
...
import {
    bookingCancelByHand,
    bookingCancelByHandVariables,
    bookingCancelReq,
    bookingCancelReqVariables,
    bookingCompleteByHand,
    bookingCompleteByHandVariables,
    bookingCreateByHand,
    bookingCreateByHandVariables,
    bookingDelete,
    bookingDeleteVariables,
    bookingFindByCode,
    bookingFindByCodeVariables,
    bookingFindByCode_BookingFindByCode_data,
    bookingFindByInfo,
    bookingFindByInfoVariables,
    bookingFindByInfo_BookingFindByInfo_data,
    bookingList,
...
export const useBookingFindByInfo = generateQueryHook<
    ...
    bookingFindByInfoVariables
>(BOOKING_FIND_BY_INFO);
export const useBookingFindByCode = generateFindQuery<
    bookingFindByCode,
    bookingFindByCodeVariables,
    bookingFindByCode_BookingFindByCode_data
>("code", BOOKING_FIND_BY_CODE);
export const useBookingList = generateListQueryHook<
    ...
    bookingListVariables,
    bookingList_BookingList_data
>(BOOKING_LIST, { initialSort: [_BookingSort.createdAt_desc] });
export const useBookingsCreate = generateMutationHook<
    bookingsCreate,
    bookingsCreateVariables
>(BOOKINGS_CREATE, {
...
export const useBookingCancelReject = generateMutationHook<
    bookingCancelReq,
    bookingCancelReqVariables
>(BOOKING_CANCEL_REJECT, {
...
export const useBookingCancelReq = generateMutationHook<
    bookingCancelReq,
    bookingCancelReqVariables
>(BOOKING_CANCEL_REQ, {
    onCompleted: ({ BookingCancelReq }) => {
...
export const useBookingCompleteByHand = generateMutationHook<
    bookingCompleteByHand,
    bookingCompleteByHandVariables
>(BOOKING_COMPLETE_BY_HAND, {
...
export const useBookingCreateByHand = generateMutationHook<
    bookingCreateByHand,
    bookingCreateByHandVariables
>(BOOKING_CREATE_BY_HAND, {
    ...getRefetch(BOOKING_LIST, BOOKING_FIND_BY_CODE),
